...
# Database
# Used for user profiles, sessions data, superuser, admin portal data, etc.
...
# else condition, if DEBUG=True, staticfiles will be served locally
else:
    STATIC_URL = '/static/'
